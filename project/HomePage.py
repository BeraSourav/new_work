...
st.markdown("<h3 style='color:brown; font-style:italic;'>Image Compressor</h3>", unsafe_allow_html=True)
...
st.markdown("<h3 style='color:brown; font-style:italic;'>Image Resizer</h3>", unsafe_allow_html=True)
...
st.markdown("<h3 style='color:brown; font-style:italic;'>PDF Compressor</h3>", unsafe_allow_html=True)
